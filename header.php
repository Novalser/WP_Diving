                ...
                <div class="container">
                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                ...
                                <img class="logo-img logo-img-main" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="">
                                <img class="logo-img logo-img-active" src="<?php echo get_template_directory_uri(); ?>/img/logo-dark.png" alt="">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            ...
                            <?php foreach (mainHeader() as $post ):
